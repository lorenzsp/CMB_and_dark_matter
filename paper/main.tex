...
By eliminating gravitational potentials, photon-baryon acous- tic oscillations eliminate the alternating peak heights from baryon loading \cite{CMB dodelson Hu} as it is evident from Figure(\ref{DM_bary}b).\\
...
%Having a third peak that is boosted to a height comparable to or exceeding the second peak is an indication that dark matter dominated the matter density in the plasma before recombination.
